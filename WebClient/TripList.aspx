<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TripList.aspx.cs" Inherits="WebClient.TripList" %>
        ...
        <asp:GridView ID="GridView1" runat="server" class="row" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
            ...
            <Columns>
                <asp:TemplateField HeaderText="" ItemStyle-Width="10">                    
                    <ItemTemplate>                       
                        <asp:CheckBox ID="CheckBox1" runat="server" data-value='<%# Eval("id") %>' />
                    </ItemTemplate>
